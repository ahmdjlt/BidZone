...
const categories = [
  ...
  { label: "Interiors", icon: "M2.25 12l8.954-8.955a1.126 1.126 0 0 1 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" },
  { label: "Jewellery", icon: "M6 3h12l3 5-9 13L3 8l3-5Zm3.5 5h5M6.5 8L12 3.5 17.5 8" },
  ...
  { label: "Wine & Spirits", icon: "M9 2.25h6m-6 0v3a6.005 6.005 0 0 1-1.764 4.236L9 2.25Zm6 0v3a6.005 6.005 0 0 0 1.764 4.236L15 2.25ZM7.5 21.75h9M12 17.25v4.5m0-4.5a6 6 0 0 1-6-6v-1.5h12v1.5a6 6 0 0 1-6 6Z" },
  ...
  { label: "Sports", icon: "M15.59 14.37a6 6 0 1 0-7.04-7.02m7.04 7.02a6 6 0 0 1-7.04-7.02m7.04 7.02l-2.83 2.83-4.24 4.24M8.55 7.35L5.72 10.18 1.48 14.42m7.07-7.07L6.4 9.5m5.3.2L9.55 11.85m5.3.21l-2.15 2.15M8 6.5l2.15-2.15m.2 5.3L8.2 11.8" },
  ...
  { label: "Musical", icon: "M9 19.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm12-3a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM9 19.5V7.5l12-3v12" },
];
