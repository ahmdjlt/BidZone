  ...
  return (
    <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
      ...
      <div className="flex flex-col gap-6">
        ...
        {/* Title */}
        <h1 className="text-3xl font-semibold tracking-tight text-blue-950 lg:text-4xl">
          {title}
        </h1>
        ...
        {/* Seller Info */}
        <div className="mt-auto rounded-2xl border border-blue-100 bg-white p-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-blue-950">{seller.name}</p>
