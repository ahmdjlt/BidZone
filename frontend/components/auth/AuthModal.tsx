  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[340px] rounded-2xl border border-border bg-card-bg p-5 shadow-2xl sm:p-6">
        ...
        {/* Social auth */}
        <p className="mt-4 text-xs font-medium text-text-muted">Continue with</p>
        <div className="mt-2 grid grid-cols-3 gap-2">
          <button
            type="button"
            className="flex items-center justify-center rounded-lg bg-[#1877F2] px-3 py-2 transition hover:brightness-110"
          >
          ...
          <button
            type="button"
            className="flex items-center justify-center rounded-lg border border-border-strong bg-surface-alt px-3 py-2 transition hover:bg-accent-soft/40"
          >
          ...
          <button
            type="button"
            className="flex items-center justify-center rounded-lg bg-[#1a1a1a] dark:bg-[#e5e5e5] px-3 py-2 transition hover:brightness-110"
          >
